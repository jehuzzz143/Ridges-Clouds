      ...
      <ul style="padding:0; margin:0;">
        ...
        <li class="activee">
          ...
          <ul class="serv-showw">
            ...
            <li><a href="rules.php">Rules & Regulartions</a></li>
            <li ><a href="rooms.php">Rooms</a></li>
            <li><a href="#">Gallery</a></li>

          </ul>
        </li>
        <li><a href="#"><i class="fas fa-user"></i>  Employee</a></li>
        <li><a href="#"><i class="fas fa-users"></i> Customer</a></li>
        <li><a href="system_database_backup"><i class="fas fa-database"></i>  System</a></li>
