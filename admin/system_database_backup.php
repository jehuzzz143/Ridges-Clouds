...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="assets/system_database_backup.css">
    <!-- CodingNepal jquery -->
...
<div class="container">
  <center>
  <h2 style="opacity: .6;margin-left: 4px; font-weight: bold;">  System Backup</h2><br>
  </center>
</div>
<div class="container is-fullhd" style="background-color:transparent;">
<?php
  include("../bmd/index.php");
?>
