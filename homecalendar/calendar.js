document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        header: {
            left: 'today',
            center: 'prev, dayGridMonth,listMonth, next',
            right: 'title'
        },
        ...
        events: url+'homecalendar/api/load.php',
        eventDrop: function(arg) {
            ...
            $.ajax({
              url:url+"homecalendar/api/update.php",
              type:"POST",
        ...
        eventClick: function(arg) {
            ...
            $.ajax({
              url:url+"homecalendar/api/getevent.php",
              type:"POST",
              dataType: 'json',
              data:{id:id},
            ...
            $('body').on('click', '#deleteEvent', function() {
                if(confirm("Are you sure you want to remove it?")) {
                    $.ajax({
                        url:url+"../calendar/api/delete.php",
                        type:"POST",
    ...
    $('#createEvent').submit(function(event) {
        ...
        $.ajax({
            type        : "POST",
            url         : url+'homecalendar/api/insert.php',
            data        : $(this).serialize(),
            dataType    : 'json',
            encode      : true
        }).done(function(data) {
